      ...
      <div className="footer-privacy">
        ...
        {lang === 'ja' ? (
          <span>
            ...
            技術を使用した Tauri デスクトップアプリケーションです。選択した画像とOCR結果はあなたのPC外部には送信されません。
          </span>
        ) : (
          <span>
            ...
            . Selected images and OCR results are never sent to any external server.
          </span>
        )}
      </div>
      <div className="footer-attribution">
        {lang === 'ja' ? (
          <span className="footer-attribution-text">
            ...
            をベースとしたデスクトップアプリケーション版です。図書館向けパイプライン機能を搭載しています。
          </span>
        ) : (
          <span className="footer-attribution-text">
            This is a desktop application version based on{' '}
            <a href="https://github.com/ndl-lab/ndlocr-lite" target="_blank" rel="noopener noreferrer">
              NDLOCR-Lite
            </a>{' '}
            developed by the National Diet Library of Japan (NDL Lab). It includes a pipeline for library table-of-contents processing.
          </span>
        )}
      </div>
